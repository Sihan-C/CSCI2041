...
---
**TA COMMENT(zhan4136)**: 
+ Your statement of the inductive case should not have quantifiers after the implication, since it is the same "instance" of x and n on both sides of the implication
+ The IH is an assumption for some arbitrary n; if we assumed P(n) is true for all n, we'd have nothing to prove!
...
**TA COMMENT(njahx004)**: 
Base Case: dont worry about what m is. we're only doing induction on n (-1)

Incorrect proof for case m = i (-2)
